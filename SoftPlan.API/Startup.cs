...
namespace SoftPlan.API
{
    public class Startup
    {
        ...
        {
            services.AddSingleton<IJuroBusiness, JuroBusiness>();
            services.AddSingleton<IJuroRepository, JuroRepository>();
